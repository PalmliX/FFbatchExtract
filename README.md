...
# How To:
Extract the .rar (sorry, zip was too big for GitHub) to anywhere on the computer you like*, then place the videos to be extracted in the "in" folder. Double click extract.bat to run the operation. When finished, the extracted videos will be in the "out" folder. Each file will be given a numbered suffix to denote the stream/channel that it was extracted from, i.e. _1, _2, _3 etc.
